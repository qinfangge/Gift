...
namespace CMS.DAL
{
	...
	public partial class Product
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(CMS.Model.Product model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Product(");
			strSql.Append("title,titleImage,price,salePrice,number,content,keywords,description,addTime,category,recommend,userId,isDel,hit,isSwitch)");
			...
			parameters[1].Value = model.titleImage;
			...
			parameters[14].Value = model.isSwitch;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(CMS.Model.Product model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.Product GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,titleImage,price,salePrice,number,content,keywords,description,addTime,category,recommend,userId,isDel,hit,isSwitch from Product ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public CMS.Model.Product DataRowToModel(DataRow row)
		{
			CMS.Model.Product model=new CMS.Model.Product();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,titleImage,price,salePrice,number,content,keywords,description,addTime,category,recommend,userId,isDel,hit,isSwitch ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,title,titleImage,price,salePrice,number,content,keywords,description,addTime,category,recommend,userId,isDel,hit,isSwitch ");
			strSql.Append(" FROM Product ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string condition, string order, int pageSize, int currentPage, bool isGeneral)
        {
            ...
            string strSql = string.Format(@"SELECT TOP  {0}  *
                            ...
                            WHERE id NOT IN
                                        (
                                        SELECT TOP  {1} id FROM Product {2} {3}
                                        )
