...
namespace CMS.DAL
{
	...
	public partial class Comment
	{
		...
		public int Add(CMS.Model.Comment model)
		{
			...
			strSql.Append("content,reply,addTime,objectId,userId,isdel,type,isChecked)");
			strSql.Append(" values (");
			strSql.Append("@content,@reply,@addTime,@objectId,@userId,@isdel,@type,@isChecked)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@content", SqlDbType.NVarChar,300),
					new SqlParameter("@reply", SqlDbType.NVarChar,300),
			...
			parameters[1].Value = model.reply;
		...
		public CMS.Model.Comment GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,content,reply,addTime,objectId,userId,isdel,type,isChecked from Comment ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public CMS.Model.Comment DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				{
					model.objectId=int.Parse(row["objectId"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,content,reply,addTime,objectId,userId,isdel,type,isChecked ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,content,reply,addTime,objectId,userId,isdel,type,isChecked ");
			strSql.Append(" FROM Comment ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
